...
class StockObserver(Observer):
    ...
    def Update(self):
        print("%s, %s, 不要看股票了，继续工作" % (self.secretary.action, self.name))

    def CloseStock(self):
        print("%s, %s, 不要看股票了，快点工作" % (self.secretary.action, self.name))
...
class NBAObserver(Observer):
    ...
    def Update(self):
        print("%s, %s, 不要看NBA了，继续工作" % (self.secretary.action, self.name))
